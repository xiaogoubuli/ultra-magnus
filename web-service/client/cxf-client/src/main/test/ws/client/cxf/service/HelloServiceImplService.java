...
public class HelloServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:../resources/hello.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:../resources/hello.wsdl");
        }
        WSDL_LOCATION = url;
    }
